<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333; line-height: 1.6;">
  ...
  <div style="background: #ffffff; padding: 30px; border-radius: 12px; border: 1px solid #eee;">
    ...
    <div style="text-align: center; margin: 30px 0;">
      <a href="<?= htmlspecialchars($feedUrl) ?>" style="background: <?= BRAND_RED ?>; color: white; padding: 12px 24px; text-decoration: none; border-radius: 8px; font-weight: bold; display: inline-block;">View Comment</a>
    </div>

    <p style="font-size: 13px; color: #666;">You can turn off these notifications anytime from your profile settings.</p>
  </div>
