<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333; line-height: 1.6;">
  ...
  <div style="background: #ffffff; padding: 30px; border-radius: 12px; border: 1px solid #eee;">
    ...
    <ul>
      <li>Our private Discord community</li>
    ...
    <div style="text-align: center; margin: 30px 0;">
      <a href="<?= htmlspecialchars(setting('discord_invite_url', '')) ?>" style="background: #5865f2; color: white; padding: 12px 24px; text-decoration: none; border-radius: 8px; font-weight: bold; display: inline-block;">Join our Discord Community</a>
    </div>
    
    <p><strong>What's next?</strong></p>
    <ol>
      <li><strong>Join Discord:</strong> Click the button above to join our active discussions, share papers, and find collaborators.</li>
  ...
  <div style="text-align: center; font-size: 12px; color: #999; margin-top: 20px;">
    &copy; <?= date('Y') ?> RARL Community. All rights reserved.<br>
