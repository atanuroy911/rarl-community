<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333; line-height: 1.6;">
  ...
  <div style="background: #ffffff; padding: 30px; border-radius: 12px; border: 1px solid #eee;">
    ...
    <p>Use the code below to verify your email address and activate your RARL Community account. This code expires in 10 minutes.</p>
    ...
    <p style="font-size: 13px; color: #666;">If you didn't create a RARL Community account, you can safely ignore this email.</p>
  </div>
