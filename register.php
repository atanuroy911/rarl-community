  ...
  <div class="w-full max-w-2xl">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
      ...
      <a href="register-individual.php"
        ...
        <div class="w-14 h-14 bg-red-900/30 border-2 border-red-700/40 rounded-2xl flex items-center justify-center text-3xl mb-5 group-hover:scale-110 transition-transform">🧑‍🔬</div>
        ...
        <ul class="space-y-1.5 mb-6">
          ...
          <li class="flex items-center gap-2 text-xs text-white/60"><span class="text-green-400">✓</span><?= $f ?></li>
          <?php endforeach; ?>
        </ul>
      ...
      <a href="register-lab.php"
        ...
        <div class="w-14 h-14 bg-blue-900/30 border-2 border-blue-700/40 rounded-2xl flex items-center justify-center text-3xl mb-5 group-hover:scale-110 transition-transform">🏫</div>
        ...
        <ul class="space-y-1.5 mb-6">
          ...
          <li class="flex items-center gap-2 text-xs text-white/60"><span class="text-blue-400">✓</span><?= $f ?></li>
          <?php endforeach; ?>
        </ul>
        <div class="flex items-center justify-between">
